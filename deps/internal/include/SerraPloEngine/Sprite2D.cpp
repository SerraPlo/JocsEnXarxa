...
namespace SerraPlo {
	...
	void Sprite2D::Load(int x, int y, int w, int h, const std::string &path, SDL_Window *window, SDL_Renderer *renderer) {
	...
	void Button2D::Draw(SDL_Renderer *renderer) override {
		SDL_Rect destRect = { position.x, position.y, width, height };
